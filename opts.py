...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--output-root', type=str, default='./image_results', help='expected output root path')
    self.parser.add_argument('--input-image', type=str, default='./A-data/', help='path to the input image')
